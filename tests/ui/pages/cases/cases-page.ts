...
export class CasesPage extends GlobalActionsAndElements {
  ...
  constructor(page: Page) {
    super(page);
    this.firstNameFilterField =
      this.getInputFieldLocatorByName('clientFirstName');
    this.middleNameFilterField =
      this.getInputFieldLocatorByName('clientMiddleName');
    this.lastNameFilterField =
      this.getInputFieldLocatorByName('clientLastName');
  ...
  async getFormattedCaseFileNumberViaApi(
    request: APIRequestContext,
    caseId: number,
  ) {
    const caseDetailsResponse = await request.get(
    ...
    return this.convertCaseFileNumberToFormattedString(
      responseObject.data.fileNumber,
    );
  }
