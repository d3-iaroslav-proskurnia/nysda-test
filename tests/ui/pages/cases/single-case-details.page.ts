...
export class SingleCaseDetailsPage extends GlobalActionsAndElements {
    ...
    constructor(page: Page) {
        ...
        this.caseDetailsNavButton = this.page.locator('button', { hasText: '💼 Case Details' });
        this.expendituresNavButton = this.page.locator('button', { hasText: '💸 Expenditures' });
        ...
        // Sections
        this.dispositionSection = this.page.locator('data-section-anchor="disposition"')
    }
}